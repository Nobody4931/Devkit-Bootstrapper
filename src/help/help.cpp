...
int program_help( int argc, char** argv ) {
	...
	std::cout << "For quickly unpacking and setting up my development toolkit on any computer\n\n";
	...
	std::cout << "\tadjust    | Automatically adjusts the size of the terminal (Windows only)\n";
